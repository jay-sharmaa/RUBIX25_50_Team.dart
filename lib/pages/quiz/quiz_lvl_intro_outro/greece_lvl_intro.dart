...
import 'package:rubix_time_machine/pages/quiz/quiz_pages/greece_quiz.dart';
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                padding: EdgeInsets.all(10),
                child: Text(
                  "YOU HAVE COMPLETED THE ANCIENT GREECE TRIVIA!",
                  style: GoogleFonts.eagleLake(
                    fontSize: 20,
                    fontWeight: FontWeight.w600,
                    color: const Color.fromARGB(255, 117, 3, 3),
